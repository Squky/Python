...
# Fine a list with cool things inside!
    ...
    # Lists are organized using: _______????? i n d e x e s

snowing = False
example_xmas = ['walkie talkies', 'socks', 'lynx', 42,4.2,snowing]
